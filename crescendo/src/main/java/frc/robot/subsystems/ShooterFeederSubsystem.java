...
public class ShooterFeederSubsystem extends SubsystemBase {
  ...
  public static boolean reached_top_sensor;
  public static boolean reached_bottom_sensor;
  public static boolean is_firing;
  public static boolean bottomState;
  public static boolean topState;
...
feeder_motor.setInverted(true);
  ...
  public void feed(int feed_type) {
     ...
     */
     ...
     bottomState = m_robot_container.getLineBreakSubsystem().getBottomState();
     topState = m_robot_container.getLineBreakSubsystem().getTopState();
