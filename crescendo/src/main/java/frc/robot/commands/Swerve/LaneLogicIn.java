...
public class LaneLogicIn extends Command {
   ...
   */
  public LaneLogicIn(SwerveBase swerveBase) {
drive = swerveBase;
 }
...
drive.drive(SelfDriving.XSpeedFinal, SelfDriving.YSpeedFinal, SelfDriving.RotationSpeedFinal, true);
